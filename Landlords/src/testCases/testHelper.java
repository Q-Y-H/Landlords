...
public class testHelper {
	...
	public void sortCards_KQJ1098765432A() {
		cards = Arrays.asList(all[13],all[12],all[11],all[10],all[9],all[8],all[7],all[6],
				all[5],all[4],all[3],all[15],all[14]);
		List<Card> expected = Arrays.asList(all[3],all[4],all[5],all[6],all[7],all[8],all[9],
				all[10],all[11],all[12],all[13],all[14],all[15]);
		Helper.sortCards(cards);
		int i = 0;
		while(i < expected.size() && expected.get(i) == cards.get(i))
			i++;
