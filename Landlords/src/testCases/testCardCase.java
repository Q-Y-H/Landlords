...
public class testCardCase {
	...
	public void sortCards_KQJ1098765432A() {
		cards = Arrays.asList(c[13], c[12], c[11], c[10], c[9], c[8], c[7], c[6], c[5], c[4], c[3], c[15], c[14]);
		List<Card> expected = Arrays.asList(c[3], c[4], c[5], c[6], c[7], c[8], c[9], c[10], c[11], c[12], c[13], c[14],
				c[15]);
		CardCase.sortCards(cards);
		int i = 0;
		while (i < expected.size() && expected.get(i) == cards.get(i))
