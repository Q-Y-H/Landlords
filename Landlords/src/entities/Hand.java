	...
	public static Hand cards2hand(List<Card> cards) {
		if (cards != null && !cards.isEmpty()) {
			...
			int startOfRank = 0, endOfRank = 0, length = 0, endOfTrio = 0, endOfQuad = 0; // length stores number of
																							// different ranks
			int[] start = new int[5]; // stores the first card's rank of different cards combination length i.e.
										// SOLO(1),PAIR(2)
			...
			if (startOfRank == 16 && endOfRank == 17)
				return new Hand(HandType.ROCKET, Rank.RANK_BLACK_JOKER);
